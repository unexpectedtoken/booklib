...
Ext.define('Ext.i18n.reader.Json', {
    ...
    extractData: function(root) {
        var me = this,
            ...
            Model = me.getModel(),
            length = root.length,
            keys, key, parts, value, convertedValues, node, record, i;
...
Ext.define('Ext.i18n.Bundle', {
    ...
    autoLoad: false,
    //TODO: review this
    model: Ext.define('Ext.i18n._modelBundle', {
        ...
        initConfig: function(instanceConfig) {
            ...
            for (k in instanceConfig) {
                if (instanceConfig.hasOwnProperty(k) && instanceConfig[k] && typeof instanceConfig[k] === 'object' && instanceConfig[k].type && instanceConfig[k].type === 'bundle') {
                    instanceConfig[k] = Ext.i18n.Bundle.instance.getMsg(instanceConfig[k].key);
                }
            }
